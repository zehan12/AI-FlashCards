    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="px-32 flex flex-col gap-6 h-[40vh]">
        ...
        <div className="flex items-center justify-between gap-6">
          <div className="flex flex-col items-center gap-4 rounded-lg border border-muted p-4 text-center bg-background">
      ...
      <section className="px-32 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between gap-8">
          {subscriptions.map((plan) => (
            <div
              key={plan.id}
              className="self-stretch flex-1 flex flex-col items-center justify-between gap-4 rounded-lg border border-muted px-4 py-8 bg-background"
            >
